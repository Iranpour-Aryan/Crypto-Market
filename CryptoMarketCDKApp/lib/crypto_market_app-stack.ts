...
export class CryptoMarketAppStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    let webappLambda = new lambda.Function(this, "CryptoMarketLambda", {
      functionName: `crypto-market-lambda-${stageName}`,
    ...
    let restApi = new apigw.LambdaRestApi(this, "CryptoMarketLambdaRestApi", {
      restApiName: `crypro-market-api-${stageName}`,
